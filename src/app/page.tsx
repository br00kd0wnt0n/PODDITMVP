            ...
            <div className="p-4 bg-poddit-950/60 border border-stone-800/25 rounded-xl">
              ...
              <div className="border-t border-stone-800/30 pt-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  <a href="https://chromewebstore.google.com/detail/poddit-%E2%80%94-save-to-your-per/kjjogneapkgcccohhiipgcokghflilnl" target="_blank" rel="noopener noreferrer"
                    className="flex flex-col items-center gap-1.5 p-2.5 rounded-lg border border-stone-800/30 bg-poddit-950/30 hover:border-teal-500/25 hover:bg-teal-500/5 transition-all group text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-stone-600 group-hover:text-teal-400 transition-colors"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="4" /><line x1="21.17" y1="8" x2="12" y2="8" /><line x1="3.95" y1="6.06" x2="8.54" y2="14" /><line x1="10.88" y1="21.94" x2="15.46" y2="14" /></svg>
                    <div><p className="text-[11px] font-medium text-stone-300 group-hover:text-teal-300 transition-colors">Chrome</p><p className="text-[9px] text-stone-600 mt-0.5">Extension</p></div>
                  </a>
