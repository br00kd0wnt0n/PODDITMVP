      ...
      <div className="space-y-6">
        ...
        <section className="p-4 bg-poddit-900/40 border border-stone-800/40 rounded-xl">
          ...
          <div className="space-y-4">
            ...
            {/* Chrome Extension */}
            <a href="https://chromewebstore.google.com/detail/poddit-%E2%80%94-save-to-your-per/kjjogneapkgcccohhiipgcokghflilnl"
              ...
              <div>
                <p className="text-sm font-medium text-stone-300 group-hover:text-stone-200 transition-colors">Chrome Extension</p>
                <p className="text-xs text-stone-500 group-hover:text-stone-400 mt-0.5 transition-colors">
                  Save any page with one click &mdash; <span className="text-teal-400/80">Install from Chrome Web Store</span>
                </p>
              </div>
            </a>
          </div>
